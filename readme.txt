...
===Page Shortcodes===
1. [glkit-list] Display the list of items
2. [glkit-list-users] Display the list of items for the logged in user
Uses shortcode to display meta data for an item (not page).

===Item Shortcodes===
1. [glkit show=id] Display the id of the item from meta data
1. [glkit show=price] Display the price of the item from meta data
1. [glkit show=colour] Display the colour of the item from meta data
1. [glkit show=supplier] Display the supplier of the item from meta data
1. [glkit show=url] Display the url as a link from the item's meta data
1. [glkit show=required] Display the required number of items from meta data
...
1. Create items and display them on pages using shortcode
